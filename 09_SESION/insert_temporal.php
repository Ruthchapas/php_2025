...
if (!$verificarUsuario || !$verificarpassword || !$verificarpassword2) {
    ...
    echo "datos que llegan a insert_user";
...
$body .= "<a href='http://localhost/php_2025/09_SESION/registro.php?token=$token' > HAZ CLIC AQUÍ PORFA </a><br>";
